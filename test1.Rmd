...
```{r}
## Not run: Example from MBC manual
data(cccma)
set.seed(1) # Univariate quantile mapping
qdm.c <- cccma$gcm.c * 0
qdm.p <- cccma$gcm.p * 0
...
abline(0, 1)
grid()
points(c(cor(cccma$rcm.c, m = 's')), c(cor(mbcp.c, m = 's')), col = 'red')
plot(
  c(cor(cccma$rcm.p, m = 's')),
  c(cor(qdm.p, m = 's')),
  col = 'black' ,
  pch = 19,
  xlim = c(-1, 1),
...
abline(0, 1)
grid()
points(c(cor(cccma$rcm.p, m = 's')), c(cor(mbcp.p, m = 's')), col = 'red')
# MBCr
dev.new()
par(mfrow = c(2, 2))
plot(
...
abline(0, 1)
grid()
points(c(cor(cccma$rcm.c, m = 's')), c(cor(mbcr.c, m = 's')), col = 'blue')
plot(
  c(cor(cccma$rcm.p, m = 's')),
  c(cor(qdm.p, m = 's')),
  col = 'black',
...
abline(0, 1)
grid()
points(c(cor(cccma$rcm.p, m = 's')), c(cor(mbcr.p, m = 's')), col = 'blue')
# MBCn
dev.new()
par(mfrow = c(2, 2))
plot(
...
abline(0, 1)
grid()
points(c(cor(cccma$rcm.c, m = 's')), c(cor(mbcn.c, m = 's')), col = 'orange')
plot(
  c(cor(cccma$rcm.p, m = 's')),
  c(cor(qdm.p, m = 's')),
  col = 'black' ,
...
abline(0, 1)
grid()
points(c(cor(cccma$rcm.p, m = 's')), c(cor(mbcn.p, m = 's')), col = 'orange') # Pairwise scatterplots
dev.new()
...
# Energy distance skill score relative to univariate
